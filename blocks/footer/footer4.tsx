  ...
  return (
    <div className="w-full py-10 lg:pb-10 bg-foreground text-background">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 gap-2 items-between border-b py-20">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:justify-center gap-2 py-8">
